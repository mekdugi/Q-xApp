 ...
 */
    ...
    private:
        ...
        struct PendingHandoverRequest
        {
            uint64_t imsi;
            uint16_t targetCellId;
        };

        void EnqueuePendingHandover(uint64_t imsi, uint16_t targetCellId);
        void ProcessPendingHandoverRequests();

        std::deque<PendingHandoverRequest> m_pendingHoRequests;
        std::mutex m_pendingHoMutex;
